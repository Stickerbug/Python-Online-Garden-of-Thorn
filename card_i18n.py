...
CARD_I18N = {
    ...
    'Leaf': {
        ...
        'effect': _t('装备拥有者回合开始时，回复目标1H；若已装备一回合，可花费1E，触发：摧毁本装备；选择一个目标，对其造成8D', "At the start of the equipment owner's turn, restore 1H to the target; after being equipped for one turn, you may spend 1E to trigger: destroy this equipment, choose a target, and deal 8D to them", "Au début du tour du propriétaire de l'équipement, rendez 1H à la cible ; après un tour d'équipement, vous pouvez dépenser 1E pour déclencher : détruisez cet équipement, choisissez une cible et infligez-lui 8D", 'No início do turno do dono do equipamento, restaure 1H ao alvo; após ficar equipado por um turno, você pode gastar 1E para acionar: destrua este equipamento, escolha um alvo e cause 8D a ele', 'В начале хода владельца снаряжения восстановите цели 1H; после одного хода в снаряжении можно потратить 1E, чтобы активировать: уничтожьте это снаряжение, выберите цель и нанесите ей 8D', '装備の所有者のターン開始時、対象のHを1回復する。1ターン装備した後、1Eを消費して発動できる：この装備を破壊し、対象を1体選び、8Dを与える'),
    },
    'Yucca': {
    ...
    'MagicLeaf': {
        ...
        'effect': _t('装备拥有者回合开始时，回复目标1M；可花费3M，触发：摧毁本装备；选择一个目标，对其造成8D', "At the start of the equipment owner's turn, restore 1M to the target; you may spend 3M to trigger: destroy this equipment, choose a target, and deal 8D to them", "Au début du tour du propriétaire de l'équipement, rendez 1M à la cible ; vous pouvez dépenser 3M pour déclencher : détruisez cet équipement, choisissez une cible et infligez-lui 8D", 'No início do turno do dono do equipamento, restaure 1M ao alvo; você pode gastar 3M para acionar: destrua este equipamento, escolha um alvo e cause 8D a ele', 'В начале хода владельца снаряжения восстановите цели 1M; можно потратить 3M, чтобы активировать: уничтожьте это снаряжение, выберите цель и нанесите ей 8D', '装備の所有者のターン開始時、対象のMを1回復する。3Mを消費して発動できる：この装備を破壊し、対象を1体選び、8Dを与える'),
    },
    'ManaOrb': {
    ...
    'Mark': {
        ...
        'effect': _t('若已装备一回合，可花费0E，触发：摧毁本装备；对目标施加1层眩晕', 'After being equipped for one turn, you may spend 0E to trigger: destroy this equipment and apply 1 Stun to the target', "Après un tour d'équipement, vous pouvez dépenser 0E pour déclencher : détruisez cet équipement et appliquez 1 Étourdissement à la cible", 'Após ficar equipado por um turno, você pode gastar 0E para acionar: destrua este equipamento e aplique 1 Atordoamento ao alvo', 'После одного хода в снаряжении можно потратить 0E, чтобы активировать: уничтожьте это снаряжение и наложите на цель 1 Оглушение', '1ターン装備した後、0Eを消費して発動できる：この装備を破壊し、対象に眩暈を1層付与する'),
    },
    'Mine': {
        ...
        'effect': _t('若已装备一回合，可花费0E，触发：摧毁本装备；选择一个目标，对其造成20D', 'After being equipped for one turn, you may spend 0E to trigger: destroy this equipment, choose a target, and deal 20D to them', "Après un tour d'équipement, vous pouvez dépenser 0E pour déclencher : détruisez cet équipement, choisissez une cible et infligez-lui 20D", 'Após ficar equipado por um turno, você pode gastar 0E para acionar: destrua este equipamento, escolha um alvo e cause 20D a ele', 'После одного хода в снаряжении можно потратить 0E, чтобы активировать: уничтожьте это снаряжение, выберите цель и нанесите ей 20D', '1ターン装備した後、0Eを消費して発動できる：この装備を破壊し、対象を1体選び、20Dを与える'),
    },
}
