...
CARD_I18N = {
    ...
    'Leaf': {
        ...
        'effect': _t('目标回合开始时，回复目标2H；若已装备一回合，可花费1E，触发：摧毁此装备，选择一个目标，对其造成8D', "At the start of the target's turn, restore 2H to the target; after being equipped for one turn, you may spend 1E to trigger: destroy this equipment, choose a target, and deal 8D to them", "Au début du tour de la cible, rendez-lui 2H ; après un tour d'équipement, vous pouvez dépenser 1E pour déclencher : détruisez cet équipement, choisissez une cible et infligez-lui 8D", 'No início do turno do alvo, restaure 2H para ele; após ficar equipado por um turno, você pode gastar 1E para acionar: destrua este equipamento, escolha um alvo e cause 8D a ele', 'В начале хода цели восстановите ей 2H; после одного хода в снаряжении можно потратить 1E, чтобы активировать: уничтожьте это снаряжение, выберите цель и нанесите ей 8D', '対象のターン開始時、対象のHを2回復する。1ターン装備した後、1Eを消費して発動できる：この装備を破壊し、対象を1体選び、8Dを与える'),
    },
    'Yucca': {
    ...
    'MagicLeaf': {
        ...
        'effect': _t('目标回合开始时，回复目标1M；可花费4M，触发：摧毁此装备，选择一个目标，对其造成12D', "At the start of the target's turn, restore 1M to the target; you may spend 4M to trigger: destroy this equipment, choose a target, and deal 12D to them", "Au début du tour de la cible, rendez-lui 1M ; vous pouvez dépenser 4M pour déclencher : détruisez cet équipement, choisissez une cible et infligez-lui 12D", 'No início do turno do alvo, restaure 1M para ele; você pode gastar 4M para acionar: destrua este equipamento, escolha um alvo e cause 12D a ele', 'В начале хода цели восстановите ей 1M; можно потратить 4M, чтобы активировать: уничтожьте это снаряжение, выберите цель и нанесите ей 12D', '対象のターン開始時、対象のMを1回復する。4Mを消費して発動できる：この装備を破壊し、対象を1体選び、12Dを与える'),
    },
    'ManaOrb': {
