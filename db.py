...
ACHIEVEMENT_DEFS = [
    ...
    {'id': 'team_double_resources', 'type': 'battle', 'name_cn': '彼竭我盈', 'name_en': 'Their Exhaustion, Our Fullness', 'description_cn': '2v2中，己方全队H、E、M曾同时达到敌方全队的2倍或更多。', 'description_en': 'In 2v2, have your team total H, E, and M simultaneously reach at least twice the enemy team total at any moment.', 'target': 1, 'metric': 'flag_team_double_resources', 'reward_dew': 600},
