...
STORY_CARD_BASE_DESCRIPTION_EN = {
    ...
    'coffee': 'Recover 3 E',
    'bur': 'Deal 8 D to the target and apply 1 Vulnerable to it',
    ...
    'rock': 'Deal 8 D to the target and apply 1 Weak to it',
    'triangle': 'Deal 3 D to the target; gain 1 Power',
    'sand': 'Deal 1 D to the target 5 times',
    'shell': 'At the start of your turn, gain 5 Shield',
    'lightning': 'Deal 3 D to all creatures 2 times',
    'magic_torch': 'Actively discard all other cards of yours; gain 4 Shield for each card discarded',
    'sponge': 'When the target takes damage, gain Poison equal to half that damage rounded up instead',
    ...
    'azalea': 'Gain 5 Shield; when this card is actively discarded, gain 3 Shield',
    'fusion': 'Double the damage of your next attack this turn',
    'chromosome': 'Gain 7 Shield; draw 1',
    'dna': 'Gain 2 Endurance',
    'moon_rock': 'Gain 30 Shield; lose 2 Power',
    ...
    'rmb': 'When a combat is won, gain 15 G',
    ...
    'cotton': 'Gain 10 Shield; this turn, your skill cards cost 1 less E, minimum 1',
    ...
    'feather': 'Draw 3',
    'magic_feather': 'Recover E equal to half your current hand size rounded down; you cannot draw more cards this turn',
    'bubble': 'Draw 3',
    ...
    'chilly': 'Draw 1 and gain 2 Temporary Power; if you draw an attack, recover 1 E',
    'jelly': 'Deal 20 D to the target; at the start of the next turn, gain 1 Attack Blocked',
    'nitro': 'Deal 10 D to the target; end the current turn and take 1 full extra turn, gaining 3 Broken at its start',
    'cogwheel': 'Draw 2; gain 2 Temporary Power for each attack drawn',
    'chloroplast': 'Gain 4 Shield; add 1 Chloroplast to your discard pile',
    'beeswax': 'Gain 8 Shield; this card is boosted by both Power and Endurance',
    ...
    'maple': 'Deal 5 D to a random creature, plus 1 extra time per 2 cards actively discarded this turn',
    ...
    'magic_assembler': 'At the start of your turn, add 1 random skill card to your hand',
...
STORY_CARD_UPGRADE_DESCRIPTION_EN = {
    ...
    'bur': 'Deal 8 D to the target and apply 2 Vulnerable to it',
    ...
    'rock': 'Deal 11 D to the target and apply 1 Weak to it',
    'triangle': 'Deal 3 D to the target; gain 1 Power, plus 1 more the first time this card is played this run',
    'sand': 'Deal 1 D to the target 7 times',
    'lightning': 'Deal 5 D to all creatures 2 times',
    'magic_torch': 'Actively discard all other cards of yours; gain 6 Shield for each card discarded',
    ...
    'cotton': 'Gain 10 Shield; this turn, all cards in your hand cost 1 less E, minimum 1',
    ...
    'sewage': 'Cards you play cost no E this turn; for each card you play, randomly actively discard 1 other card of yours',
    'mjolnir': 'Deal 19 D to the target; this card can be upgraded indefinitely',
    ...
    'nitro': 'Deal 14 D to the target; end the current turn and immediately take 1 full extra turn, gaining 2 Broken at its start',
    'cogwheel': 'Draw 3; gain 2 Temporary Power for each attack drawn',
    'chloroplast': 'Gain 6 Shield; add 1 upgraded Chloroplast to your discard pile',
    'beeswax': 'Gain 11 Shield; this card is boosted by both Power and Endurance',
    ...
    'magic_assembler': 'At the start of your turn, add 1 random upgraded skill card to your hand',
