...
VALID_LOGIC_OPS = {
    ...
    "emit",
    "log",
    "bio_activate_blood_knife", "bio_activate_blood_chromosome", "bio_clear_poison_fire",
    "bio_add_extra_healing", "bio_add_shield_conversion", "bio_job_application", "bio_indictment_response",
    ...
    "sewers_blood_rose",
    "sewers_iodine_turn_start",
    "sewers_iodine_trigger",
    "sewers_cheese_control",
    "sewers_chitin_turn_start",
    "sewers_seal_target_equipment",
    "sewers_basil_turn_start",
    "sewers_neurotoxin",
    "sewers_quartz",
    "jurassic_magic_soil_on_equip",
    "jurassic_random_deck_to_hand",
    "jurassic_magic_fang",
    ...
    "jurassic_acid",
    "jurassic_torch",
    "jurassic_magic_torch",
    "jurassic_pyrite_draw",
    "jurassic_antler",
    "arctic_apply_frost",
